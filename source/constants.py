...
JUMP_FIREBALL_ATTACK_PERIOD = 0.3
GRENADE_ATTACK_PERIOD = 0.3
SLIDE_PERIOD = 2
ACCELERATION = 1.5
...
GRENADE_ATTACK_FILE_STEM = os.path.expanduser('~/Desktop/coding/games//symmetry-ninja/artassets/sprites/ninja/sixtyfps/throw/scaled/Throw__00%i_%i.png')
JUMP_FIREBALL_ATTACK_FILE_STEM = os.path.expanduser('~/Desktop/coding/games/symmetry-ninja/artassets/sprites/ninja/sixtyfps/jumpattack/scaled/Jump_Attack__00%i_%i.png')
